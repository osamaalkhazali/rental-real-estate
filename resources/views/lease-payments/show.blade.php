                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <dl class="space-y-2">
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Lease:</dt>
                                    <dd>{{ $leasePayment->lease->tenant_name }} -
                                        {{ $leasePayment->lease->apartment->display_name }}</dd>
                                </div>
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Month:</dt>
                                    <dd>{{ $leasePayment->month }}</dd>
                                </div>
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Due Date:</dt>
                                ...
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Payment Date:</dt>
                        ...
                        <div>
                            ...
                            <dl class="space-y-2">
                                ...
                                @endif
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Receipt:</dt>
                                    <dd>
